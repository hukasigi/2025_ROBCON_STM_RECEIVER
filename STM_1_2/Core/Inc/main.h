...
#define PWM3_TIM2_CH2_Pin GPIO_PIN_1
#define PWM3_TIM2_CH2_GPIO_Port GPIOA
#define VCP_TX_Pin GPIO_PIN_2
#define VCP_TX_GPIO_Port GPIOA
#define PWM4_TIM3_CH2_Pin GPIO_PIN_4
#define PWM4_TIM3_CH2_GPIO_Port GPIOA
#define DIR4_Pin GPIO_PIN_5
#define DIR4_GPIO_Port GPIOA
#define PWM2_T3_C3_Pin GPIO_PIN_0
#define PWM2_T3_C3_GPIO_Port GPIOB
#define DIR2_Pin GPIO_PIN_1
#define DIR2_GPIO_Port GPIOB
#define PWM_test_T1_C1_Pin GPIO_PIN_8
#define PWM_test_T1_C1_GPIO_Port GPIOA
